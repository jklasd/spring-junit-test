...
import com.github.jklasd.test.core.common.methodann.mock.h2.MysqlToH2;
...
public abstract class AbstractMockHandler implements MockClassHandler{
	...
	protected InheritableThreadLocal<MysqlToH2> mysqlToH2Mock = new InheritableThreadLocal<>();
